import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as r,c as l,d,b as e,a as n,e as t,f as v}from"./app-558815da.js";const c="/backend-note/数字电路验证/EDAplayground.png",u="/backend-note/数字电路验证/EDAplayground_result.png",o={},m=v(`<h1 id="_5、environment类和testcase类的创建及仿真" tabindex="-1"><a class="header-anchor" href="#_5、environment类和testcase类的创建及仿真" aria-hidden="true">#</a> 5、environment类和testcase类的创建及仿真</h1><h2 id="_5-1-environment" tabindex="-1"><a class="header-anchor" href="#_5-1-environment" aria-hidden="true">#</a> 5.1 environment</h2><div class="language-systemverilog line-numbers-mode" data-ext="systemverilog"><pre class="language-systemverilog"><code>class my_env extends uvm_env;
